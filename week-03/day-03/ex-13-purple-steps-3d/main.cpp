...
void draw() {
    ...
    for (int i = 0; i < 7; i++) {
        ...
        //create a rectangle
        SDL_Rect fillRect = {prevXPos + i * size, prevYPos + i * size, size*(i+1), size*(i+1)};
        SDL_Rect drawRect = {prevXPos + i * size, prevYPos + i * size, size*(i+1), size*(i+1)};
        ...
        prevXPos = prevXPos + size* i;
        prevYPos = prevYPos + size*i;
    }
}
