...
void draw()
{
    ...
    SDL_SetRenderDrawColor(gRenderer, 0xFF /*R*/, 0xAA /*G*/, 0x00 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 3*SCREEN_WIDTH/4, 0, 3*SCREEN_WIDTH/4, SCREEN_HEIGHT);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xAA /*G*/, 0x00 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 0, SCREEN_HEIGHT/4, SCREEN_WIDTH, SCREEN_HEIGHT/4);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xAA /*G*/, 0xFF /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 0, 3*SCREEN_HEIGHT/4, SCREEN_WIDTH, 3*SCREEN_HEIGHT/4);
